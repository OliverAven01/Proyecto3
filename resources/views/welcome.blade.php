...
<head>
    ...
    <link href="./CSS/estilos_mp.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css" integrity="sha512-xh6O/CkQoPOWDdYTDqeRdPCVd1SpvCA9XXcUnZS2FmJNp1coAFzvtCN9BmamE+4aHK8yyUHUSCcJHgXloTyT2A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <title>MY-GOOD-KITCHEN</title>
</head>
<body>
  <header>
        <div class="navbar navbar-dark bg-dark box-shadow">
          <div class="container d-flex justify-content-between flex-row">
            <a href="mainpage.html" class="navbar-brand d-flex align-items-center">
                ...
                <strong class="fa-sharp fa-solid fa-user-chef">My Good Kitchen</strong>
            </a>
            <a href="Nosotros.html" class="btn btn-dark btn-sm">Acerca de nosotros</a>
            <a href="#" class="btn btn-dark btn-sm">Blog</a>
            <a href="#" class="btn btn-dark btn-sm">Unirse</a>
          </div>
        </div>
    </header>
    ...
    <main class="main" id="main">
        ...
        <section class="jumbotron text-center">
          <div class="container">
            <h1 class="jumbotron-heading text-light encabezado">My Good Kitchen</h1>
    ...
    <div class="container">
        ...
        <p>Nuestras redes sociales:
            ...
            <p>© 2023 MyGoodKitchen. Derechos Reservados</p>
        </p>
    </div>
    </footer>
</body>
